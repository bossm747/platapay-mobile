...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-gradient-to-r from-blue-900 via-blue-700 to-purple-900">
      {/* Side Menu for Desktop */}
      <div className="hidden lg:flex lg:flex-col lg:w-64 lg:bg-purple-900 lg:text-white lg:h-screen lg:shadow-2xl">
        <div className="p-4 flex flex-col justify-between h-full">
          <div className="flex-1 overflow-y-auto">
            <div className="flex items-center mb-8">
              <img src={logoUrl} alt="Platapay Logo" className="h-10 w-auto mr-2" />
          ...
          <div className="mt-4">
            <Link to="/login" className="flex items-center px-2 py-3 hover:bg-purple-700 text-sm">
              <LogIn className="text-white w-6 h-6 mr-2" />
      ...
      <div className="flex-1 flex flex-col">
        {/* Sticky Header */}
        <div className="w-full flex justify-between items-center bg-purple-900 text-white p-4 lg:hidden">
          <Menu className="text-white cursor-pointer" onClick={() => setMenuOpen(!menuOpen)} />
          <div className="flex items-center">
            <img src={logoUrl} alt="Platapay Logo" className="h-8 w-auto mr-2" />
            <span className="text-2xl font-bold">Platapay</span>
          </div>
