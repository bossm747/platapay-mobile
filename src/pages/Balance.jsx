...
import { Bell, Phone, ArrowRight, Bank, FileText, Hand, PiggyBank, UserPlus, Plant, ShoppingCart, Gift, Leaf, CreditCard } from "lucide-react";
...
const Balance = () => {
  const services = [
    ...
    { title: "Transfer", icon: <Bank className="text-blue-900" /> },
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center bg-gradient-to-r from-blue-900 via-blue-700 to-purple-900">
      ...
      <div className="flex items-center mt-16">
        ...
        <div className="ml-4">
          <div className="text-white">Platapay</div>
      ...
      <div className="bg-white rounded-lg p-4 mt-8 w-11/12">
        <div className="text-blue-900 text-center">Services</div>
