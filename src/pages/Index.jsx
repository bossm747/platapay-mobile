    ...
    <div className="h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-900 via-blue-700 to-purple-900">
      ...
      <div className="flex-1 flex flex-col items-center justify-center mt-8">
        ...
        <div className="bg-white rounded-lg p-4 mt-4 w-11/12 shadow-lg">
          <h2 className="text-blue-900 text-lg font-bold">New Container</h2>
          <p className="text-blue-900 mt-2">This is a new container added between the buttons and the group of services.</p>
        </div>
        {/* Transaction Container */}
        <div className="bg-white rounded-lg p-4 mt-4 w-11/12 shadow-lg">
          <h2 className="text-blue-900 text-lg font-bold">Transactions</h2>
          <p className="text-blue-900 mt-2">Cash In and Cash Out transactions will be displayed here.</p>
        </div>
        {/* Spacer */}
