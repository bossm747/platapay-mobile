  ...
  return (
    <div className="bg-gradient-to-r from-blue-900 via-blue-700 to-purple-900 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-blue-900 via-blue-700 to-purple-900 text-white p-4">
        ...
        <Button className="shadow-lg shadow-[rgba(0,0,0,0.5)] text-white bg-blue-700 active:shadow-none active:translate-y-1 mt-4">View Benefits</Button>
      </div>
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center py-2 mt-4 border-t border-gray-200">
          <Button className="shadow-lg shadow-[rgba(0,0,0,0.5)] text-white bg-blue-700 active:shadow-none active:translate-y-1 w-full mt-4">
            Log Out
          </Button>
        </div>
      </div>
